# Installing ArcGIS Software and Using AZCopy to copy files from Azure Blob Storage where installer files are stored
...
param(
    ...
    [Parameter()]                 [string] $ArcGISLicenseUrl
)
...
Write-Host "ArcGIS License URL : $ArcGISLicenseUrl"
